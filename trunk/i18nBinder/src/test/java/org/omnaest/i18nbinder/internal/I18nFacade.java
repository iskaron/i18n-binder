 ...
 * <br>
 * If the facade class is instantiated with a given {@link Locale} using {@link #I18nFacade(Locale)} all non static methods will
 * use this predefined {@link Locale} when invoked.<br>
 * <br>
 * The facade methods will silently ignore all {@link MissingResourceException}s by default. To alter this behavior see
 * {@link #I18nFacade(Locale, boolean)}<br>
 * <br>
 * 
 * @see I18n
 */
@Generated(value = "org.omnaest.i18nbinder.I18nBinder", date = "2012-01-02T18:06:33+01:00")
public class I18nFacade
{
  ...
  protected static ResourceBasedTranslator resourceBasedTranslator = new ResourceBasedTranslator()
                                                                   {
                                                                     @Override
                                                                     public String translate( String baseName,
                                                                                              String key,
                                                                                              Locale locale )
                                                                     {
                                                                     ...
                                                                     @Override
                                                                     public String[] resolveAllKeys( String baseName,
                                                                                                     Locale locale )
                                                                     {
                                                                       ResourceBundle resourceBundle = ResourceBundle.getBundle( baseName,
                                                                                                                                 locale );
   ...
   * To modify please adapt the underlying property files.<br>
   * <br>
   * If the facade class is instantiated with a given {@link Locale} using {@link #I18n(Locale)} all non static methods will use
   * this predefined {@link Locale} when invoked.<br>
   * <br>
   * The facade methods will silently ignore all {@link MissingResourceException}s by default. To alter this behavior see
   * {@link #I18n(Locale, boolean)}<br>
   * <br>
  ...
  public static class I18n
  {
     ...
     * To modify please adapt the underlying property files.<br>
     * <br>
     * If the facade class is instantiated with a given {@link Locale} using {@link #_673numericalTest(Locale)} all non static
     * methods will use this predefined {@link Locale} when invoked.<br>
     * <br>
     * The facade methods will silently ignore all {@link MissingResourceException}s by default. To alter this behavior see
     * {@link #_673numericalTest(Locale, boolean)}<br>
     * <br>
     * Resource base: <b>i18n.673numericalTest</b> <br>
     * <br>
     * <h1>Examples:</h1>
     * <table border="1">
     * <thead>
    ...
    public static class _673numericalTest
    {
      ...
      /**
       * This {@link _673numericalTest} constructor will create a new instance which silently ignores any
     ...
     * To modify please adapt the underlying property files.<br>
     * <br>
     * If the facade class is instantiated with a given {@link Locale} using {@link #AdminTest(Locale)} all non static methods
     * will use this predefined {@link Locale} when invoked.<br>
     * <br>
     * The facade methods will silently ignore all {@link MissingResourceException}s by default. To alter this behavior see
     * {@link #AdminTest(Locale, boolean)}<br>
     * <br>
     * Resource base: <b>i18n.adminTest</b> <br>
     * <br>
     * <h1>Examples:</h1>
     * <table border="1">
     * <thead>
     ...
     * To modify please adapt the underlying property files.<br>
     * <br>
     * If the facade class is instantiated with a given {@link Locale} using {@link #LocalelessTest(Locale)} all non static
     * methods will use this predefined {@link Locale} when invoked.<br>
     * <br>
     * The facade methods will silently ignore all {@link MissingResourceException}s by default. To alter this behavior see
     * {@link #LocalelessTest(Locale, boolean)}<br>
     * <br>
     * Resource base: <b>i18n.localelessTest</b> <br>
     * <br>
     * <h1>Examples:</h1>
     * <table border="1">
     * <thead>
    ...
    public static class LocalelessTest
    {
      ...
      /**
       * This {@link LocalelessTest} constructor will create a new instance which silently ignores any
       * {@link MissingResourceException}
       * 
       * @see LocalelessTest
       * @param locale
     ...
     * To modify please adapt the underlying property files.<br>
     * <br>
     * If the facade class is instantiated with a given {@link Locale} using {@link #ViewTest(Locale)} all non static methods will
     * use this predefined {@link Locale} when invoked.<br>
     * <br>
     * The facade methods will silently ignore all {@link MissingResourceException}s by default. To alter this behavior see
     * {@link #ViewTest(Locale, boolean)}<br>
     * <br>
     * Resource base: <b>i18n.viewTest</b> <br>
     * <br>
     * <h1>Examples:</h1>
     * <table border="1">
     * <thead>
